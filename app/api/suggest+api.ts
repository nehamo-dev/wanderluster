...
{ "kind": "${removedEvent.kind}", "time": "HH:MM or null", "title": "Specific place or restaurant name", "meta": "Neighbourhood or one short note", "suggested": true }
...
- Return pure JSON only`;
    ...
    console.error('[suggest api]', err?.message ?? err);
