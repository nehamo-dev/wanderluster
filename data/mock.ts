...
export const PAST_TRIPS: Folio[] = [
  {
    ...
    season: 'Autumn',
    vibe: 'Culture · Food',
    palette: { a: '#c8b090', b: '#8a5a30', c: '#1a1208' },
    visa: null,
    teaser: 'Seven days in the Eternal City.',
    days: [],
    docs: [],
  },
  {
    ...
    season: 'Spring',
    vibe: 'Culture · Slow',
    palette: { a: '#c4a890', b: '#8a5a44', c: '#2a1e16' },
    visa: null,
    teaser: 'Cherry blossoms and quiet temples.',
    days: [],
    docs: [],
  },
  {
    ...
    destination: 'Lisbon',
    country: 'Portugal',
    dates: 'Sep 12 – 19, 2025',
    duration: '7 days',
    season: 'Late summer',
    vibe: 'Culture · Slow',
    palette: { a: '#d4b87a', b: '#9a6a2a', c: '#1a1008' },
    visa: null,
    teaser: 'Miradouros and custard tarts at dusk.',
    days: [],
    docs: [],
  },
];
